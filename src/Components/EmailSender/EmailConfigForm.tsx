                        ...
                        {(showPopup === 'message') && <DynamicValuePopup
                            ...
                            onClick={(value) => {
                                if (cursorPosition.current.selectionStart !== 0 && cursorPosition.current.selectionEnd !== 0) {
                                    const firstPart = emailBody.message.slice(0, cursorPosition.current.selectionStart) + '@' + value + ' ';
                                    const secondPart = emailBody.message.slice(cursorPosition.current.selectionEnd);
                ...
                <div className="input-container">
                    ...
                    <div style={{ position: 'relative' }}>
                        ...
                        {(showPopup === 'footer') && <DynamicValuePopup
                            ...
                            onClick={(value) => {
                                if (cursorPosition.current.selectionStart !== 0 && cursorPosition.current.selectionEnd !== 0) {
                                    const firstPart = emailBody.footer.slice(0, cursorPosition.current.selectionStart) + '@' + value + ' ';
                                    const secondPart = emailBody.footer.slice(cursorPosition.current.selectionEnd);
