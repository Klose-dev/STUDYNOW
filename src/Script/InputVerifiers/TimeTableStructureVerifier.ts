export default function verifyTimeTableStructureInputs(timeTableStructureFieldValues: any, onError: (msg: string) => void = () => { }) {
    const timeTableStructure = Object();
    ...
    const semesterCount = timeTableStructureFieldValues.semesterCount
    ...
    // must be an positive integer number
    const periodCount = timeTableStructureFieldValues.periodCount;
